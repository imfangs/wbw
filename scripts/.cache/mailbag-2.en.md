...
Last month, I emailed readers announcing an upcoming mailbag post—the WBW post version of an AMA. 1,500 questions poured in—remarkably interesting, creative questions on a wide range of topics. I picked some for this round, and we’re keeping the rest in a database that I’ll go back to for future mailbags ([\[email protected\]](/cdn-cgi/l/email-protection#b5d8d4dcd9d7d4d2f5c2d4dcc1d7c0c1c2ddcc9bd6dad8) is always open, so send questions anytime and we’ll add them to the list).
...
Like how big all the bacteria in the human body would be if you clumped it all together. I had always heard the famous stat that there are 10 times as many bacteria in your body as human cells. It turns out that [that’s been debunked](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4991899/#:~:text=Given%20the%20dominance%20of%20bacteria,body%20is%20about%2050%E2%80%93100g.). The real ratio is closer to 1:1, with both kinds of cells in the ballpark of 40 trillion in an adult human body.[2](#footnote-2-9079)

Anyway, the NIH [estimates](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4991899/#:~:text=Given%20the%20dominance%20of%20bacteria,body%20is%20about%2050%E2%80%93100g.) that all that bacteria adds up to only 0.3% of a human’s body mass. Zachary is 7, so let’s estimate his mass at 25 kg. That means the bacteria in his body adds up to 75 grams—about the weight of a plum. Assuming the density of Zachary’s bacteria is similar to the density of his body, that would make the bacteria ball about the *size* of a plum too.

[![](/images/mailbag-2/19-zachary-plum.png)](https://waitbutwhy.com/wp-content/uploads/2021/04/19-zachary-plum.png)

This led me to the obvious next question: how big would all the bacteria on Earth be if you bunched them all together?[3](#footnote-3-9079)
...
The pessimistic part of my brain says: A) 70–100. My grandparents lived to 84, 87, 91, and good old Nana is still going strong at 95.[5](#footnote-5-9079) My lifestyle is not a big enough step above theirs, healthwise, to imagine that I’ll beat them out by very much. And sure, medicine is improving dramatically, but then I look at charts like this one (click for bigger view):[1](#footnote2-1-9079)
...
Going to Gen Yamamoto’s bar in Tokyo for six of the fanciest little cocktails imaginable (he’s kind of the Jiro of cocktails) over two amazing hours.[8](#footnote-8-9079) Also just the entire country of Japan in general.
...
**If you were forced to **live in a country outside of the [top 50](https://www.usnews.com/news/best-countries/overall-rankings)** for 5 years, which country would it be and why?** – *Dom W. (New York, NY)*
...
Of the staples, I love Scrabble and have played like 1,000 games of Words With Friends (which has in turn fucked up my Scrabble game). I have periodic chess phases, though they never last long enough for me to become not bad (my [chess.com](https://chess.com/) rating peaked in the 900s during my last bout).
...
Some of these pits are at least productive, [when](https://www.youtube.com/channel/UCYO_jab_esuFRV4b17AJtAw) [I’m](https://www.youtube.com/user/LivBoeree/videos) [learning](https://www.youtube.com/user/Vihart/featured) [something](https://www.youtube.com/user/CGPGrey) [about](https://www.youtube.com/user/minutephysics) [science](https://www.youtube.com/channel/UCsXVk37bltHxD1rDPwtNM8Q) [or](https://www.youtube.com/channel/UCCODtTcd5M1JavPCOr_Uydg) [history](https://www.youtube.com/channel/UCNIuvl7V8zACPpTmmNIqP2A). Others at least [are](https://www.youtube.com/channel/UCb0Etli2WY2PX8ILEzDsSJQ) [high](https://www.youtube.com/channel/UCxcnsr1R5Ge_fbTu5ajt8DQ) [quality](https://www.youtube.com/user/Guldies) [art](https://www.youtube.com/channel/UCO7fujFV_MuxTM0TuZrnE6Q) [or](https://www.youtube.com/playlist?list=PLFEE651C298476F00) [comedy](https://www.youtube.com/user/GradeAUnderA/videos?view=0&sort=p&flow=grid) [or](https://www.youtube.com/user/onemeeeliondollars) [something](https://www.youtube.com/channel/UCBJycsmduvYEL83R_U4JriQ) [else](https://www.youtube.com/channel/UCrPUg54jUy1T_wII9jgdRbg) [interesting](https://www.youtube.com/channel/UCAL3JXZSzSm8AlZyD3nQdBA).
...
**Do you think, overall, covid accelerated progress of the [human colossus](https://waitbutwhy.com/2017/04/neuralink.html) or slowed down progress of the human colossus?** – *Sean M. (New Orleans, LA)*
...
1.  Depending on how transparent viruses are, we might need to stack a bunch of these virus squares to make it opaque enough to see, which would raise the total number of viruses needed into the millions or even billions.[↩](#note-1-9079)
    
2.  The NIH does [note](https://www.nih.gov/news-events/news-releases/nih-human-microbiome-project-defines-normal-bacterial-makeup-body) that most of the human cells are red blood cells (a further rabbit hole reminded me that red blood cells look like [delicious gummy candy](https://www.google.com/search?q=red+blood+cells&sxsrf=ALeKk01fL1df9ojB10ZGMzPYFILbbKbCug:1617579053371&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjUy_zG3-XvAhXSMd8KHaUYDmoQ_AUoAXoECAEQAw&biw=1664&bih=1257)), and they admit that red blood cells are kind of just “bags full of hemoglobin.” If you only count human cells with a nucleus, the ratio *is* 10 bacteria for every human cell.[↩](#note-2-9079)
    
3.  Zachary got more than he bargained for here.[↩](#note-3-9079)
    
4.  As a one-time budding film composer, it used to be stressful playing the score I had written for the director the first time. They had inevitably become attached to their stupid temp score (the existing film scores directors put into the film before handing it over to the composer to write the original music) and were hearing mine for the first time, so they’d predictably (infuriatingly!) not like it on the first listen. I’d play it for them a few times and the next day, they’d listen again and usually would suddenly like it. Film scoring is annoying.[↩](#note-4-9079)
    
5.  Every time I call her, Nana asks me when my book will be done, and her new thing is telling me now that I’ll be very regretful if she dies before she gets to put it on her coffee table—thanks Nana![↩](#note-5-9079)
    
6.  If you sleep in a bed with someone else, you probably can’t just listen out loud to stuff without bothering them. A single AirPod solves the problem for me—and you can just take it out when you’re drifting off and that pauses the podcast (or video).[↩](#note-6-9079)
    
7.  A more austere version of this is just having books or a Kindle in the bedroom and phone elsewhere. But I like the variety the bed phone gives me.[↩](#note-7-9079)
    
8.  Email [\[email protected\]](/cdn-cgi/l/email-protection#afc0c9c9c6cccaefc8cac1d6cec2cec2c0dbc081c5df) to make a reservation, at least a month before you’ll be in Tokyo.[↩](#note-8-9079)
...
10.  It’s always an option to just skip the big catch-up with friends you don’t see very often, but that’s not great either because it’s hard to be close when you don’t know what’s going on with someone.[↩](#note-10-9079)
     
11.  A less risky option if your mammoth is flipping out is to invite the person to a gathering you’re organizing.[↩](#note-11-9079)
     

* * *

1.  [Our World in Data](https://ourworldindata.org/)[↩](#note2-1-9079)
